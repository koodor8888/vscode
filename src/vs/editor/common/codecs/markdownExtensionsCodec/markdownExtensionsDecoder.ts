 ...
 */
export type TMarkdownExtensionsToken = MarkdownExtensionsToken | TSimpleToken;

/**
 * TODO: @legomushroom
 */
export class MarkdownExtensionsDecoder extends BaseDecoder<TMarkdownExtensionsToken, TSimpleToken> {
	/**
