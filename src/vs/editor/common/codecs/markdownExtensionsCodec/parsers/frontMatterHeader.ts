 ...
 * TODO: @legomushroom
 */
export class PartialFrontMatterStartMarker extends ParserBase<TSimpleToken, PartialFrontMatterStartMarker | PartialFrontMatterHeader> {
	...
	@assertNotConsumed
	public accept(token: TSimpleToken): TAcceptTokenResult<PartialFrontMatterStartMarker | PartialFrontMatterHeader> {
 ...
 * TODO: @legomushroom
 */
export class PartialFrontMatterHeader extends ParserBase<TSimpleToken, PartialFrontMatterHeader | FrontMatterHeaderToken> {
	/**
	 * TODO: @legomushroom
	 */
	...
	@assertNotConsumed
	public accept(token: TSimpleToken): TAcceptTokenResult<PartialFrontMatterHeader | FrontMatterHeaderToken> {
	...
	private handleEndMarkerParsingFailure(
		accumulatedTokens: readonly TSimpleToken[],
 ...
 * TODO: @legomushroom
 */
class PartialFrontMatterEndMarker extends ParserBase<TSimpleToken, PartialFrontMatterEndMarker | FrontMatterMarker> {
	constructor(token: Dash) {
		const { range } = token;
	...
	@assertNotConsumed
	public accept(token: TSimpleToken): TAcceptTokenResult<PartialFrontMatterEndMarker | FrontMatterMarker> {
		const previousToken = this.currentTokens[this.currentTokens.length - 1];
